  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 pt-6">
        ...
        <Link to="/admin/partners" className="group rounded-2xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1">
          <div className="mb-4 text-3xl">🤝</div>
          <h3 className="font-bold text-foreground group-hover:text-primary transition-colors">Growth Partners</h3>
          <p className="text-xs text-muted-foreground mt-2">Manage marketing campaigns, copies, and view partner performance.</p>
        </Link>
      </div>
    </div>
  );
