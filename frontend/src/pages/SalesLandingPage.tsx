...
const FLYER_BADGES = ["6 WEEKS", "100% ONLINE", "SATURDAY AI CLASSES", "SUNDAY MONETIZATION WORKSHOPS", "DOUBLE MONEY-BACK GUARANTEE"];
...
const CountdownTimer: React.FC<{ targetDate: string; variant: 'banner' | 'hero' }> = ({ targetDate, variant }) => {
  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 sm:p-6 max-w-2xl mx-auto grid grid-cols-4 gap-1.5 sm:gap-3 text-center shadow-sm">
      {[
        ...
        <div key={idx} className="bg-white p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-100 shadow-sm">
          <div className="text-xl sm:text-4xl font-sans font-black text-orange-600">{String(unit.val).padStart(2, '0')}</div>
          <div className="text-[10px] sm:text-xs uppercase font-black text-slate-500 tracking-wider mt-0.5 sm:mt-1.5">{unit.label}</div>
        </div>
      ))}
    </div>
  );
...
const SalesLandingPage: React.FC = () => {
  ...
  const targetDate = "2026-08-15T23:59:59";
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-orange-500 selection:text-white font-sans overflow-x-hidden">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-2 px-3 sm:py-2.5 sm:px-4 text-center text-xs sm:text-sm font-black uppercase tracking-[0.15em] relative z-50 flex flex-wrap justify-center items-center gap-1.5 sm:gap-2">
      ...
      <section className="relative pt-12 pb-12 sm:pt-28 sm:pb-24 px-4 sm:px-6 overflow-hidden bg-white">
        {/* Background glow highlights */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[300px] sm:h-[600px] bg-orange-100/40 blur-[80px] sm:blur-[120px] rounded-full -z-10" />
        <div className="absolute top-[20%] right-[-10%] w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-slate-100/50 blur-[80px] rounded-full -z-10" />
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-10">
          <div className="flex justify-center mb-2 sm:mb-8 anim-fade-down">
            <div className="p-1 rounded-xl bg-slate-55 bg-slate-50 border border-slate-200/80 shadow-sm">
          ...
          <div className="space-y-2">
            <h1 
              className="text-4xl sm:text-6xl md:text-7xl font-sans font-black tracking-tight leading-[1.2] text-slate-900 anim-scale-in"
              id="hero-heading"
            >
              Master Data Analytics: Become  <span className="text-orange-600 italic">Job-Ready</span>  In 6 Weeks
            </h1>
          </div>

          <p 
            className="text-slate-600 text-base sm:text-2xl max-w-3xl mx-auto leading-relaxed font-medium px-1 anim-fade-up-d2"
          >
            Get the technical power of <span className="text-slate-900 font-extrabold relative inline-block mx-1">
              <span className="relative z-10 font-bold italic">Excel + SQL + Power BI + AI</span>
              <span className="absolute bottom-1 left-0 w-full h-2 bg-orange-500/20 -z-10 rounded-full" />
          ...
          <div className="flex flex-wrap gap-2 justify-center max-w-xl mx-auto pt-2">
            {FLYER_BADGES.map((b, i) => (
              <span key={i} className="px-3 py-1 text-xs font-black tracking-wider text-orange-700 border border-orange-200 bg-orange-50 rounded-full uppercase">
                {b}
              </span>
            ))}
          </div>
          ...
          <div className="flex flex-col items-center pt-2 sm:pt-6 anim-fade-up-d3">
            <a 
              ...
              id="cta-hero-enroll"
              className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 transition-colors text-white px-6 sm:px-12 py-4.5 sm:py-6 rounded-xl font-black text-base sm:text-xl uppercase tracking-wider shadow-[0_10px_25px_rgba(234,88,12,0.3)] active:scale-95 flex items-center justify-center gap-2"
            >
              Claim My Grand Slam Offer Now <ArrowRight className="h-5 w-5 sm:h-6 sm:w-6 animate-pulse" />
            </a>
            <p className="mt-3.5 text-slate-600 text-xs sm:text-sm font-extrabold uppercase tracking-wider flex items-center gap-1.5">
              <Clock className="h-4 w-4 text-orange-600" /> Only {slotsLeft} of {slotCap} Seats Remaining for {month} Batch!
            </p>
          </div>

          {/* Social Proof Intro Card */}
          <div className="mt-10 sm:mt-16 bg-slate-50 text-slate-900 p-6 sm:p-10 rounded-2xl border border-slate-200/80 shadow-md text-left relative overflow-hidden anim-fade-up-d5">
            <div className="absolute top-0 right-0 p-4 opacity-[0.03]">
              <Users className="h-16 w-16 sm:h-24 sm:w-24 text-orange-600" />
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 relative z-10">
              <div className="shrink-0 w-16 h-16 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-slate-200 shadow-sm bg-slate-200">
                 <img src="/ayodeji_trainer.jpg" alt="Coach Omidoyin Ayodeji" className="w-full h-full object-cover" loading="lazy" />
              </div>
              <div className="space-y-1.5 text-center sm:text-left">
                <h3 className="text-base sm:text-2xl font-sans font-black tracking-tight leading-snug uppercase text-slate-950">
                  "I don't just teach data analytics. I install a system that enables you to build high-paying dashboard services."
                </h3>
                <p className="text-orange-600 font-black uppercase tracking-wider text-xs sm:text-sm flex items-center justify-center sm:justify-start gap-1">
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 bg-slate-50 border-t border-b border-slate-100">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-10">
          <div className="text-center space-y-2">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 border border-orange-200 text-orange-600 text-xs font-black uppercase tracking-wider mb-2">
                A System Tailored for Career Pivots
             </div>
             <h2 className="text-2xl sm:text-4xl font-sans font-black tracking-tight uppercase leading-tight text-slate-950">WHO IS THIS <span className="text-orange-600">TRAINING</span> FOR?</h2>
             <p className="text-slate-600 text-sm sm:text-base font-semibold mt-2">Designed primarily to help the following people bypass struggle:</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            {WHO_IT_IS_FOR.map((item, i) => (
              <div key={i} className="bg-white border border-slate-200 p-5 sm:p-6 rounded-xl shadow-sm transition-all flex items-start gap-3.5 text-left">
                <div className="h-9 w-9 rounded-lg bg-orange-50 flex items-center justify-center text-orange-600 shrink-0">
                  <Users className="h-5 w-5" />
                </div>
                <div className="space-y-1">
                  <h3 className="text-base sm:text-lg font-sans font-black tracking-tight uppercase text-slate-900">{item.cat}</h3>
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed tracking-wide font-medium">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-center w-full">
               <p className="text-emerald-800 text-sm sm:text-base font-black uppercase tracking-wide">
            ...
            <a 
              href="#enroll-section" 
              onClick={scrollToEnroll}
              className="hidden sm:flex w-full sm:w-auto bg-orange-600 text-white px-8 py-4.5 rounded-xl font-black text-sm uppercase tracking-widest shadow-lg shadow-orange-600/20 transition-all hover:scale-[1.02] items-center justify-center gap-2"
            >
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 overflow-hidden relative bg-white">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-10">
          <div className="text-center">
             <span className="text-orange-600 text-xs font-black uppercase tracking-wider block mb-2">MAXIMUM VALUE • MINIMUM FRICTION</span>
             <h2 className="text-2xl sm:text-4xl font-sans font-black tracking-tight uppercase leading-tight text-slate-950">BY THE END OF THIS ACCELERATOR, YOU WILL BE ABLE TO:</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
             <div className="relative aspect-video sm:aspect-square md:aspect-auto rounded-2xl overflow-hidden group shadow-md bg-gradient-to-br from-slate-100 via-orange-100 to-slate-50 border border-slate-200 flex items-end min-h-[180px] md:min-h-[350px]">
               <div className="absolute inset-0 flex items-center justify-center opacity-10">
                 <svg viewBox="0 0 100 100" className="w-24 h-24 text-orange-600" fill="currentColor"><path d="M50 10 L90 30 L90 70 L50 90 L10 70 L10 30 Z"/></svg>
               </div>
               <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 via-slate-900/10 to-transparent" />
               <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-orange-600 p-4 rounded-lg shadow-sm">
            ...
            <div className="space-y-3">
              {OUTCOMES.map((item, i) => (
                <div 
                  key={i} 
                  className={`flex gap-3 items-start sm:items-center p-4 bg-white border border-slate-200 rounded-xl hover:border-orange-500/50 transition-colors shadow-sm group anim-right-${i}`}
                >
                  <div className="h-6 w-6 rounded-full bg-orange-50 flex items-center justify-center text-orange-600 shrink-0 mt-0.5 sm:mt-0">
              ...
              <a 
                href="#enroll-section" 
                onClick={scrollToEnroll}
                className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 rounded-lg font-black text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shadow-md"
              >
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 bg-orange-50/15 border-t border-b border-orange-100/40">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="text-center space-y-1">
             <h4 className="text-orange-600 font-black uppercase tracking-wider text-xs sm:text-sm">Real Proof: High Likelihood of Success</h4>
             <h2 className="text-xl sm:text-4xl font-sans font-black tracking-tight leading-tight uppercase px-1 text-slate-950">"THE ACADEMY REMOVED MY STUCK-FEELINGS & GAVE ME PRACTICAL PORTFOLIO POWER"</h2>
          </div>

          <div className="bg-white text-slate-900 p-6 sm:p-10 rounded-2xl border border-slate-200 shadow-md relative">
            <div className="absolute -top-2.5 -left-2.5 bg-orange-600 p-2 rounded-lg text-white shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center text-center sm:text-left">
              ...
              <div className="space-y-1.5 flex-1">
                <div>
                  <h3 className="text-base sm:text-lg font-sans font-black text-orange-600 uppercase">Cornelius</h3>
                  <p className="text-xs font-black text-slate-500 uppercase tracking-widest">Data Analyst Trainee, Batch 2</p>
                </div>
                <div className="relative">
                  <span className="absolute -top-3 -left-3 text-3xl text-slate-100 font-sans leading-none -z-10">"</span>
                  <p className="text-slate-700 text-sm leading-relaxed tracking-wide font-medium italic relative z-10">
          ...
          <Link to="/reviews" className="w-full sm:w-auto bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-800 px-5 py-3 rounded-lg font-black text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 mx-auto">
            To See More Real Student Proof (Click Here) <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-md mx-auto bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-md">
          <div className="relative aspect-[4/3] bg-slate-950">
            <img src="/Testimonial_segun.jpg" alt="Segun Testimonial" className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent" />
            <div className="absolute bottom-4 left-4 right-4">
              <h3 className="text-lg font-sans font-black text-white uppercase">Segun</h3>
              <p className="text-orange-400 font-black uppercase tracking-wider text-xs mt-0.5">Cohort 2 Student</p>
            </div>
          </div>
          <div className="p-4 bg-slate-50 flex flex-col sm:flex-row gap-2 justify-center border-t border-slate-200/80">
            <a 
              href="#enroll-section" 
              onClick={scrollToEnroll}
              className="hidden sm:inline-block w-full sm:w-auto bg-orange-600 text-white px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] transition-all shadow-md text-center"
            >
              Claim My Grand Slam Offer
            </a>
            <Link to="/reviews" className="w-full sm:w-auto bg-white hover:bg-slate-100 border border-slate-200 text-slate-800 px-4 py-3 rounded-lg font-black text-xs uppercase tracking-wider transition-all text-center">
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 bg-slate-55 bg-slate-50 border-t border-b border-slate-100">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-12">
          <div className="text-center space-y-2">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-55 bg-orange-50 text-orange-600 text-xs font-black uppercase tracking-wider border border-orange-200">
               6-Week System Milestones
             </div>
             <h2 className="text-2xl sm:text-5xl font-sans font-black tracking-tight leading-none text-slate-950">
               THE SYSTEM <span className="text-orange-600">MILESTONES</span>
             </h2>
             <p className="text-slate-600 text-sm sm:text-base font-semibold max-w-xl mx-auto leading-relaxed mt-2">
          ...
          <div className="space-y-3 max-w-2xl mx-auto">
            {MODULES.map((mod, i) => {
              ...
              return (
                <div 
                  key={i} 
                  className={`bg-white border ${isOpen ? 'border-orange-500 bg-orange-50/5' : 'border-slate-200'} rounded-xl overflow-hidden hover:border-orange-500/40 transition-all shadow-sm group`}
                >
                  <button
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <span className="bg-orange-600 text-white font-black text-xs tracking-wider px-3 py-1 rounded-full shrink-0">
                        {mod.step}
                      </span>
                      <h3 className="text-sm sm:text-base font-sans font-black tracking-tight text-slate-900 group-hover:text-orange-600 transition-colors">
                        {mod.title}
                      </h3>
                    </div>
                    <ChevronDown className={`h-5 w-5 text-slate-400 transition-transform duration-300 shrink-0 ${isOpen ? 'rotate-180 text-orange-600' : ''}`} />
                  </button>

                  <div 
                    className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[500px] border-t border-slate-100 opacity-100 p-4' : 'max-h-0 opacity-0 p-0 pointer-events-none'}`}
                  >
                    <div className="space-y-3 text-left">
                      <div>
                        <span className="text-xs font-black tracking-wider text-orange-700 bg-orange-50 px-2 py-0.5 rounded">
                           {mod.objection}
                        </span>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed tracking-wide font-medium">
                        {mod.desc}
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto pt-6">
             <a 
               ...
               className="hidden sm:flex w-full sm:w-auto bg-orange-600 text-white px-8 py-4.5 rounded-xl font-black text-sm uppercase tracking-widest shadow-lg shadow-orange-600/20 transition-all hover:scale-[1.02] items-center justify-center gap-2"
             >
               Start Learning Now <ArrowRight className="h-4.5 w-4.5" />
             </a>
          </div>
        </div>
      </section>
      ...
      <section className="hidden sm:block py-12 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-white border-b border-slate-200/60">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-orange-100/20 blur-[100px] rounded-full -z-10" />
        
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-3">
             <span className="text-orange-600 text-sm font-black uppercase tracking-wider">Return on Investment</span>
             <h2 className="text-3xl sm:text-5xl font-sans font-black tracking-tight leading-tight uppercase text-slate-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            {/* Path 1 */}
            <div className="bg-slate-50 border border-slate-200 p-6 sm:p-8 rounded-2xl space-y-6 flex flex-col justify-between hover:border-orange-500/40 transition-all text-left shadow-sm">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-orange-700 border-orange-200 text-xs font-black uppercase tracking-wider">
                  Career Acceleration
                </div>
                <h3 className="text-xl sm:text-2xl font-sans font-black text-slate-900 uppercase">
                ...
                <div className="space-y-3 pt-2">
                  {[
                    ...
                    <div key={idx} className="flex gap-2 items-center text-slate-700 font-bold text-sm">
                      <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0" />
                      <span>{item}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-slate-50 border border-slate-200 p-6 sm:p-8 rounded-2xl space-y-6 flex flex-col justify-between hover:border-orange-500/40 transition-all text-left shadow-sm">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-55 bg-emerald-50 text-emerald-700 text-xs font-black uppercase tracking-wider border border-emerald-200">
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-slate-50 border-t border-b border-slate-200/80">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[400px] bg-orange-100/15 blur-[120px] rounded-full -z-10" />
        
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-12">
          <div className="text-center space-y-2">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-orange-600 text-xs font-black uppercase tracking-wider border border-orange-200">
               Your No-Brainer Value Stack
             </div>
             <h2 className="text-2xl sm:text-5xl font-sans font-black tracking-tight leading-none uppercase text-slate-950">
               <span className="text-orange-600 italic">THE GRAND SLAM OFFER STACK</span>
             </h2>
             <p className="text-slate-600 text-sm sm:text-base font-semibold max-w-xl mx-auto leading-relaxed mt-2">
          ...
          <div className="bg-white border-4  border-orange-500/30 p-6 sm:p-10 rounded-2xl shadow-lg space-y-6 sm:space-y-8 max-w-2xl mx-auto text-left relative">
             <div className="absolute top-3 right-3 bg-orange-600 text-white px-2 py-0.5 rounded-full text-xs font-black uppercase tracking-wider rotate-2 shadow-md">
                Unbeatable Offer
             </div>
             ...
             <div className="block sm:hidden space-y-3">
                <div className="space-y-2.5">
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <span>Core 6-Week Accelerator <span className="text-orange-600 font-bold">(₦150,000)</span></span>
                   </div>
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <p>
                       <span className="text-green-600 font-bold">✓ Bonus #1:</span> <span>Recruiter ATS Resume Templates <span className="text-orange-600 font-bold">(₦25,000)</span></span>
                     </p>
                     <p>
                   ...
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <p>
                       <span className="text-green-600 font-bold">✓ Bonus #2:</span> <span>LinkedIn visibility Sprint Script <span className="text-orange-600 font-bold">(₦30,000)</span></span>
                     </p>
                   </div>
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <p>
                       <span className="text-green-600 font-bold">✓ Bonus #3:</span> <span>SME Outreach proposal & templates <span className="text-orange-600 font-bold">(₦20,000)</span></span>
                     </p>
                   </div>
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <p>
                       <span className="text-green-600 font-bold">✓ Bonus #4:</span> <span>10 Proprietary Real Business Datasets <span className="text-orange-600 font-bold">(₦25,000)</span></span>
                     </p>
                   </div>
                   <div className="flex items-start gap-2 text-sm leading-relaxed tracking-wide font-medium text-slate-800">
                     <CheckCircle2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
                     <p>
                       <span className="text-green-600 font-bold">✓ Bonus #5:</span> <span>WhatsApp VIP coach support & Network <span className="text-orange-600 font-bold">(₦50,000)</span></span>
                     </p>
                   </div>
                </div>
             </div>
             ...
             <div className="hidden sm:block space-y-6 divide-y divide-slate-100">
                   ...
                   <div key={idx} className={`pt-6 flex flex-col sm:flex-row justify-between items-start gap-4 ${idx === 0 ? 'border-none pt-0' : ''}`}>
                      <div className="space-y-2 flex-1">
                         <div className="flex items-center gap-2 flex-wrap">
                            <h4 className="text-slate-900 font-bold text-sm sm:text-base tracking-tight">{item.title}</h4>
                            <span className="text-xs font-black text-orange-700 bg-orange-50 px-2 py-0.5 rounded">
                               {item.objection}
                            </span>
                         </div>
                         <p className="text-slate-500 text-[11px] sm:text-xs leading-relaxed">{item.sub}</p>
                      </div>
                      <div className="text-orange-600 font-sans font-black text-sm sm:text-base shrink-0 uppercase tracking-widest sm:self-center">
                         {item.val}
                      </div>
                   </div>
                ))}
             ...
             <div className="space-y-2 pt-4 border-t border-slate-200">
                ...
                <div className="flex justify-between items-center border-t border-slate-200 pt-3">
                   <span className="text-slate-900 font-black text-sm sm:text-base uppercase tracking-wider">Your Grand Slam Price Today:</span>
                   <div className="text-right">
                      <span className="text-2xl sm:text-3xl font-sans font-black text-orange-600 tracking-tight">{formatCurrency(fullProgramPrice)}</span>
                      <p className="text-xs font-black tracking-wider uppercase text-slate-500">( <span className="text-xs font-sans font-black text-orange-600">Installments</span> Available) </p>
                   </div>
                </div>
             </div>
             <div className="text-xs font-black text-orange-600 text-center uppercase tracking-wider">
             ...
             <div className="text-center">
                <a 
                  href="#enroll-section" 
                  onClick={scrollToEnroll}
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3.5 px-4 rounded-lg font-black text-xs sm:text-sm uppercase tracking-wider shadow-md transition-all inline-block text-center"
                >
      ...
      <section className="hidden sm:block py-12 sm:py-24 px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto bg-white text-slate-900 rounded-[2rem] overflow-hidden border border-slate-200 shadow-xl flex flex-col md:flex-row">
           <div className="p-6 sm:p-10 space-y-6 md:w-3/5">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-55 bg-orange-50 text-orange-600 text-xs font-black uppercase tracking-wider border border-orange-200">
                High-Flex Efficiency System
              </div>
              <h2 className="text-2xl sm:text-4xl font-sans font-black tracking-tight leading-none uppercase">
                TRAINING <span className="text-orange-600 italic">SCHEDULE</span>
              </h2>
              <p className="text-sm text-slate-600 font-bold uppercase tracking-tight">HOW WE REDUCE YOUR WEEKLY EFFORT:</p>
              
              <div className="space-y-4">
                 <div className="flex gap-3 items-start">
                    <div className="h-8 w-8 bg-emerald-600 rounded-lg flex items-center justify-center text-white shrink-0 shadow-md">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 italic font-medium text-slate-500 text-xs sm:text-sm">
                Busy schedule? You retake or review any recording via your private student dashboard with permanent lifetime access.
              </div>
           </div>
           
           <div className="md:w-2/5 bg-slate-50 border-l border-slate-200/80 p-6 sm:p-10 flex flex-col justify-center text-center space-y-6 relative overflow-hidden">
              <div className="h-1 w-10 bg-orange-600 rounded-full mx-auto" />
              <div className="space-y-2 relative z-10">
                 <p className="text-orange-600 font-black uppercase tracking-wider text-xs">Direct Risk-Reversal</p>
                 <h3 className="text-xl sm:text-2xl text-slate-900 font-sans font-black uppercase leading-tight">LIMITED TO ONLY 30 SEATS</h3>
                 <p className="text-slate-600 text-xs font-medium">{slotSecured}/{slotCap} spots secured. Only {slotsLeft} spots remaining for the {month} 6th class.</p>
              </div>
              <a 
                href="#enroll-section" 
                onClick={scrollToEnroll}
                className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 rounded-xl font-black text-xs uppercase tracking-widest shadow-xl shadow-orange-600/30 relative z-10 text-center"
              >
                Enroll Now
              </a>
           </div>
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-white">
        <div className="max-w-4xl mx-auto bg-white text-slate-900 border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
           <div className="md:w-1/2 relative bg-slate-100 min-h-[220px] sm:min-h-[450px]">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900 via-slate-900/60 to-transparent p-4 sm:p-6 text-white">
                 <h3 className="text-lg sm:text-xl font-sans font-black leading-tight uppercase">Omidoyin Ayodeji</h3>
                 <p className="text-orange-400 font-black uppercase tracking-wider text-xs">CEO & Lead Data Analyst Trainer</p>
              </div>
           </div>
           
           <div className="md:w-1/2 p-4 sm:p-10 space-y-4 text-left flex flex-col justify-between">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 px-2 py-0.5 rounded-full bg-slate-100 text-slate-700 text-xs font-black uppercase tracking-wider">
                  Elite Mentorship & Capstone Proof
                </div>
                <h2 className="text-2xl sm:text-3xl font-sans font-black tracking-tight uppercase leading-[1.1] text-slate-950">
                  MEET YOUR <br/><span className="text-orange-600 italic">MENTOR</span>
                </h2>
                
                <div className="space-y-1.5">
                   {MENTOR_POINTS.map((point, i) => (
                      <div key={i} className="flex gap-2 items-start font-bold text-slate-700 text-sm">
                         <div className="h-1.5 w-1.5 rounded-full bg-orange-600 shrink-0 mt-1.5" />
                         <p>{point}</p>
                      </div>
                   ))}
                </div>
                ...
                <div className="pt-3 border-t border-slate-200 space-y-1">
                   <h4 className="text-xs font-black uppercase text-slate-900 tracking-wider">THE VELEON CAPSTONE STANDARD:</h4>
                   <p className="text-slate-600 text-sm leading-relaxed tracking-wide font-medium">
      ...
      <section  className="py-12 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-slate-50 border-t border-b border-slate-200/80">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[250px] bg-orange-100/15 blur-[90px] rounded-full -z-10" />
        ...
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-12">
          ...
          <div className="text-center space-y-2">
             ...
             <h2 className="text-2xl sm:text-5xl font-sans font-black tracking-tight leading-none uppercase text-slate-950">
               SECURE YOUR SPOT <br/>
               <span className="text-orange-600 italic">FOR {month} 2026 NOW</span>
             </h2>
             <p className="text-orange-600 text-xs sm:text-sm font-black uppercase tracking-wider max-w-md mx-auto animate-pulse mt-2">
               ⚡️ FINAL SPOTS REMAINING - REGISTRATION CLOSING SOON
             </p>
          </div>

          {/* Simple 4-Step Process Indicator */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3.5 max-w-4xl mx-auto text-left">
            {CHECKOUT_STEPS.map((step, i) => (
               <div 
                  ...
                  className="bg-white p-4 rounded-xl border border-slate-200 flex items-start gap-3 hover:border-orange-500/40 hover:scale-[1.02] cursor-pointer transition-all shadow-sm select-none"
               >
                  <div className="h-6 w-6 rounded bg-orange-600 text-white flex items-center justify-center font-black text-xs shrink-0 shadow-lg shadow-orange-600/10">{step.n}</div>
                  <div className="space-y-0.5">
                     <h4 className="text-xs font-black uppercase tracking-tight text-slate-900">{step.t}</h4>
                     <p className="text-slate-600 text-xs sm:text-sm leading-relaxed tracking-wide font-medium">{step.d}</p>
                  </div>
               </div>
            ))}
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 p-6 sm:p-10 rounded-2xl flex flex-col md:flex-row items-center gap-6 text-left relative max-w-3xl mx-auto shadow-md">
             <div className="shrink-0 h-12 w-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 shadow-inner">
                <ShieldCheck className="h-7 w-7 animate-pulse" />
             </div>
             <div className="space-y-2">
                <h3 className="text-base sm:text-2xl font-sans font-black uppercase tracking-tight text-orange-700 italic">
                   THE UNBEATABLE "DO-THE-WORK" DOUBLE GUARANTEE
                </h3>
                <p className="text-slate-700 text-sm sm:text-sm leading-relaxed tracking-wide font-medium">
                   We absorb 100% of the risk:
                   <span className="block mt-2 text-slate-900 font-extrabold text-base">
             ...
             <div className="absolute -top-2.5 -right-2 bg-orange-600 text-white px-2.5 py-0.5 rounded-full text-xs font-black uppercase tracking-wider shadow-lg rotate-3">
                Zero Risk
             </div>
          </div>

          {/* Checkout Core Form Panel - Tighter padding & inputs */}
          <div id="checkout-panel" className="bg-white text-slate-900 rounded-2xl border-t-4 border-orange-600 border-l border-r border-b border-slate-200/80 shadow-xl overflow-hidden max-w-3xl mx-auto p-5 sm:p-8 text-left grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-start">
             ...
             <div id="enroll-section" className="space-y-4" >
                <div className="space-y-1.5">
                   ...
                   <div className="flex bg-slate-100 p-0.5 rounded-lg border border-slate-200">
                      <button
                         ...
                         className={`flex-1 text-center py-1.5 rounded text-xs font-black uppercase tracking-wider transition-all ${!isInstallment ? 'bg-orange-600 text-white shadow-md' : 'text-slate-500 hover:text-slate-900'}`}
                      >
                         Pay In Full
                      </button>
                      <button
                ...
                <div className="space-y-1">
                   ...
                   <p className="text-slate-500 text-xs font-black tracking-wider uppercase">Select which program track you are enrolling for:</p>
                </div>
                ...
                <div className="flex flex-col gap-2.5">
                   ...
                   <button 
                     ...
                     className={`w-full p-4 rounded-xl border-2 text-left relative overflow-hidden transition-all flex flex-col gap-1 ${selectedTrack === 'full' ? 'border-orange-500 bg-orange-50/5 shadow-sm' : 'border-slate-200 bg-white hover:border-orange-500/40'}`}
                   >
                      <div className="absolute top-0 right-0 bg-orange-600 text-white px-2 py-0.5 text-xs font-black uppercase tracking-wider">
                        Best Value
                      </div>
                      <p className="text-slate-500 font-black uppercase tracking-wider text-xs">Option 1</p>
                      ...
                      <p className="text-slate-600 text-xs font-medium mt-1 leading-tight italic">
                         {isInstallment 
                   ...
                   <button 
                     ...
                     className={`w-full p-4 rounded-xl border-2 text-left relative overflow-hidden transition-all flex flex-col gap-1 ${selectedTrack === 'excel_only' ? 'border-orange-500 bg-orange-50/5 shadow-sm' : 'border-slate-200 bg-white hover:border-orange-500/40'}`}
                   >
                      <p className="text-slate-500 font-black uppercase tracking-wider text-xs">Option 2</p>
                ...
                <div className="p-3 bg-orange-50 rounded-lg border border-orange-200 flex gap-2 items-center">
             ...
             <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 space-y-4 w-full">
                <div className="space-y-1">
                   ...
                   <p className="text-slate-500 text-xs font-medium leading-tight">Your data is safe and encrypted.</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-3.5">
                   <div className="space-y-1">
                     <label className="text-xs font-black uppercase tracking-wider text-slate-600 ml-0.5">Full Name</label>
                     <input 
                       type="text" 
                       required
                   ...
                   <div className="space-y-1">
                     <label className="text-xs font-black uppercase tracking-wider text-slate-600 ml-0.5">Email Address</label>
                     <input 
                       type="email" 
                       required
                   ...
                   <div className="space-y-1">
                     <label className="text-xs font-black uppercase tracking-wider text-slate-600 ml-0.5">WhatsApp Number</label>
                     <input 
                       type="tel" 
                       required
                   ...
                   <div className="space-y-1.5 pt-2 border-t border-slate-200">
                      <div className="flex justify-between items-center text-xs font-black uppercase tracking-tight text-slate-900">
                        ...
                        <span className="text-lg text-orange-600 font-sans font-black">
                   ...
                   <button type="submit" className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3.5 rounded-lg font-black text-sm uppercase tracking-wider transition-all shadow-md active:scale-95 flex items-center justify-center gap-1.5">
                     SECURE MY SEAT NOW <ArrowRight className="h-4 w-4" />
                   </button>
                   ...
                   <a 
                     ...
                     className="w-full bg-[#25D366] hover:bg-[#20ba5a] text-white py-2.5 rounded-lg font-black text-xs uppercase tracking-wider text-center flex items-center justify-center gap-1.5 shadow-sm transition-all active:scale-95"
                   >
                ...
                <div className="pt-2 border-t border-slate-200">
                    <div className="bg-white p-3.5 rounded-xl border-dashed border-2 border-slate-200 space-y-2 text-xs">
                      <div className="flex items-center gap-1.5 text-slate-600 font-black uppercase text-xs tracking-wider">
                        <Building2 className="h-4.5 w-4.5 animate-pulse text-orange-600" /> Fast Manual Transfer Option
                      </div>

                      <p className="text-slate-600 ml-0.5 leading-relaxed text-xs">To bypass automated gateway delays and lock in your Fast-Action discount instantly, you can transfer directly to our head coach. Onboarding approved within 15 minutes.</p>
                      <div className="space-y-0.5 pt-1.5">
                        <div className="flex justify-between items-center">
                           <span className="font-bold text-slate-500 uppercase text-xs">Bank:</span>
                           <span className="font-black text-slate-900">Guaranty Trust Bank (GTB)</span>
                        </div>
                        <div className="flex justify-between items-center">
                           <span className="font-bold text-slate-500 uppercase text-xs">Account Name:</span>
                           <span className="font-black text-slate-900 truncate">Ayodeji Omidoyin</span>
                        </div>
                        <div className="flex justify-between items-center">
                           <span className="font-bold text-slate-500 uppercase text-xs">Account Number:</span>
                           <span className="font-black text-slate-900 text-sm select-all underline decoration-orange-600 decoration-2">0212516916</span>
                        </div>
                      </div>
                      <div className="bg-[#25D366]/5 p-2 rounded-md border border-[#25D366]/20 text-emerald-800 text-xs font-black uppercase tracking-wider text-center font-bold">
      ...
      <section className="py-12 sm:py-24 px-4 sm:px-6 border-t border-slate-200 bg-white">
        <div className="max-w-2xl mx-auto space-y-6 sm:space-y-10">
          <div className="text-center space-y-2">
             <h2 className="text-2xl sm:text-4xl font-sans font-black tracking-tight uppercase text-slate-950">
          ...
          <div className="space-y-4">
             {FAQS.map((faq, idx) => (
                <div key={idx} className="pb-4 border-b border-slate-200/80 space-y-2 text-left">
                  <div className="flex gap-2 items-start">
                     <span className="text-orange-600 font-sans font-black text-base shrink-0">Q.</span>
                     <h3 className="font-sans font-black text-sm sm:text-lg text-slate-900 leading-tight">
                       {faq.q}
                     </h3>
                  </div>
                  <p className="text-slate-600 text-sm leading-relaxed tracking-wide font-medium pl-5">
                    {faq.a}
                  </p>
                </div>
             ))}
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 px-4 py-3 flex items-center justify-between shadow-lg">
        <div className="space-y-0.5">
           <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">{month} Batch Enrollment</p>
        ...
        <a 
          href="#enroll-section"
          onClick={scrollToEnroll}
          className="bg-orange-600 text-white px-5 py-2.5 rounded-lg font-black text-xs uppercase tracking-wider active:scale-95 transition-transform flex items-center gap-1.5"
        >
      ...
      {/* Footer minimal */}
      <footer className="py-12 sm:py-20 border-t border-slate-200 text-center space-y-4 px-4 pb-20 md:pb-20 bg-slate-50">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-slate-500 text-xs font-bold uppercase tracking-wider">
           ...
           <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="hover:text-orange-600 transition-colors">Contact Support</a>
        </div>
        <p className="text-xs uppercase tracking-wider text-slate-500 font-medium">© {new Date().getFullYear()} Veleon Academy. All Rights Reserved.</p>
      </footer>
    </div>
  );
};
